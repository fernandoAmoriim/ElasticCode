...
public class Exercicio18 {
    public static void main(String[] args) {
        ...
        Integer idade = LocalDate.now().getYear() - scanner.nextInt();
        ...
        if (mes == 4 || mes == 6 || mes == 9 || mes == 11){
            if (dia > 30){
                ...
                System.out.println("Parabéns! Seu aniversário é válido! %d de %s, %s trimestre. Você tem %d anos e seu signo é %s".formatted(dia, meses[mes - 1], trimestre, idade, signo));
            }
        }else {
            if (dia > 31){
                System.out.println("Dia do Mês inválido.");
